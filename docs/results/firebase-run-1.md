<!-- PROMOTED by the coordinator from impl/firebase-v1:firebase/results/firebase-run-1.md
     at e48de4c on 2026-08-28. Verbatim; the build owns the content, the coordinator owns
     placement. docs/results/** is coordinator-only per territory.md. -->
